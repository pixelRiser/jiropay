...
<head>
    <meta charset="utf-8">
    <title>Nouvelle demande d'agent</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 28px 24px;">
                            <h1 style="font-size: 18px; margin: 0 0 12px; color:#1a1a1a;">
                                Nouvelle demande de compte agent
                            </h1>
                            <p style="font-size: 14px; color:#444; line-height: 1.6; margin: 0 0 16px;">
                                <strong>{{ $agent->name }}</strong> ({{ $agent->email }}) a demandé à rejoindre
                                le guichet <strong>{{ $agent->guichet->nom ?? '—' }}</strong> en tant qu'agent.
                            </p>
                            <p style="font-size: 14px; color:#444; line-height: 1.6; margin: 0 0 16px;">
                                Rendez-vous dans l'administration JiroPay, section "Agents", pour approuver
